<template>
  ...
  <div class="showtimes-page">
    ...
    <div class="showtimes-filter">
      <button class="btn-cinema-picker" @click="openCinemaModal">
...
import CinemaSelectModal from '@/external/components/CinemaSelectModal.vue'
...
function openCinemaModal(){ showCinemaModal.value = true }
function onCinemaSelected(cinema){ selectedCinemaObj.value = cinema; showCinemaModal.value = false }
...
function bookMovie(movie) {
  alert(`Đặt vé cho phim: ${movie.tenPhim}`)
}
...
.btn-cinema-picker { padding: 10px 16px; border-radius: 8px; border: 1.5px solid #48dbfb; background: #232526; color: #fff; font-size: 1rem; cursor: pointer; }
.showtimes-list {
  max-width: 1100px;
  margin: 0 auto;
  display: grid;
