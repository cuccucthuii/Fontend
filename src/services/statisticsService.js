...
export function fetchTotalRevenue(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics`, { params })
}

// Doanh thu theo tháng với params động
export function fetchMonthlyRevenue(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/month`, { params })
}

// Thống kê doanh thu theo rạp với params động
export function fetchTheaterStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/theater`, { params })
}

// Thống kê doanh thu theo phim với params động
export function fetchMovieStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/movie`, { params })
}

// Thống kê theo ngày
export function fetchDailyStatistics(date) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics`, {
...
export function fetchStatisticsByType(type, params = {}) {
  ...
  return axios.get(`${API_BASE_URL}/api/admin/statistics`, { params: baseParams })
}
...
export function fetchShowtimeStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/showtime`, { params })
}

// Thống kê theo giờ chiếu
export function fetchHourlyStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/hourly`, { params })
}

// Thống kê theo phòng chiếu
export function fetchRoomStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/room`, { params })
}

// Thống kê tỷ lệ lấp đầy phòng
export function fetchOccupancyStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/occupancy`, { params })
}

// Thống kê suất chiếu hot nhất
export function fetchTopShowtimes(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/top-showtimes`, { params })
}

// Thống kê giờ vàng (peak hours)
export function fetchPeakHoursStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/peak-hours`, { params })
}

// Thống kê khách hàng
export function fetchCustomerStatistics(params = {}) {
  return axios.get(`${API_BASE_URL}/api/admin/statistics/customers`, { params })
}
