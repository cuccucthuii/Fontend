...
function goToBooking() {
  const movieId = movie.value?.id || movie.value?.idPhim || route.params.id
  console.log('MovieDetailPage - movie.value:', movie.value)
  console.log('MovieDetailPage - route.params.id:', route.params.id)
  console.log('MovieDetailPage - movieId:', movieId)
  if (!movieId) {
    console.error('Movie ID not found')
    return
  }
  console.log('MovieDetailPage - navigating to booking with movieId:', String(movieId))
