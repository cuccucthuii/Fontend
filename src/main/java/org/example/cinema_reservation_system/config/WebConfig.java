...
//                .allowedOrigins("http://localhost:5173")    // frontend chạy trên cổng 5173
//                .allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS") // các method cho phép
//                .allowedHeaders("*")                         // cho phép tất cả header
//                .allowCredentials(true);                     // cho phép gửi cookie nếu có
//
        registry.addMapping("/uploads/**")                  // Cho phép truy cập file uploads
                .allowedOrigins("http://localhost:5173")    // frontend chạy trên cổng 5173
                .allowedMethods("GET", "OPTIONS")           // chỉ cho phép GET cho static files
                .allowedHeaders("*")                         // cho phép tất cả header
                .allowCredentials(true);                     // cho phép gửi cookie nếu có
    }
}
